...
const updateEmailField = yup.string().email().min(8, "Email Must contain 8 or more characters")
...
export {emailField, updateEmailField, pwField, confirmPwField, updatePwField, 
